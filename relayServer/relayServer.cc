...
class relayServer
{
    ...
    void disableConn(shared_ptr<Connection> conn)
    {
    ...
    void clientClose(shared_ptr<Connection> conn)//由其他线程调用
    {
        //new verson
    ...
    */
    ...
    map<shared_ptr<Connection>, shared_ptr<Connection> > connfdMap_;
    Mutex mutex_;
};
